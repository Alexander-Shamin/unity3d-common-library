  ...
  where U : IDontDestroyOnLoad
{
    ...
    get {
      ...
      else
      {
        ...
        if (managers != null)
        {
          ...
          {
            instance = managers[0];
            if (typeof(U) == typeof(DontDestroyOnLoadEnable)) DontDestroyOnLoad(instance);
            return instance;
          }
          else
          {
        ...
        if (typeof(U) == typeof(DontDestroyOnLoadEnable)) DontDestroyOnLoad(instance.gameObject);
        return instance;
      }
    }
  ...
  protected virtual void Awake()
  {
    if (instance == null)
    {
      if (typeof(U) == typeof(DontDestroyOnLoadEnable)) DontDestroyOnLoad(gameObject);
      instance = this as T;
    }
    else
    {
