...
namespace Common
{
	...
	{
		public override Vector3Int ReadJson(Newtonsoft.Json.JsonReader reader, Type objectType, Vector3Int existingValue, bool hasExistingValue, JsonSerializer serializer)
		{
