...
public class JsonFileStorage
{
  ...
  public void Deserialize() { storage = DeserializeDictionary(path2file); }

  public void Serialize() { SerializeDicitionary(Storage, path2file); }
  ...
  {
    get {
      if (storage == null) storage = DeserializeDictionary(path2file);
      return storage;
    }
  }
  ...
  public bool ContainstKey(string name) { return Storage.ContainsKey(name); }
