...
public class UnityThread : MonoBehaviour
{
  ...
  ////////////////////////////////////////////////UPDATE
  /// IMPL////////////////////////////////////////////////////////
  // Holds actions received from another Thread. Will be coped to actionCopiedQueueUpdateFunc then
  // executed from there
  ...
  // Used to know if whe have new Action function to execute. This prevents the use of the lock
  // keyword every frame
  private volatile static bool noActionQueueToExecuteUpdateFunc = true;

  ////////////////////////////////////////////////LATEUPDATE
  /// IMPL////////////////////////////////////////////////////////
  // Holds actions received from another Thread. Will be coped to actionCopiedQueueLateUpdateFunc
  ...
  ////////////////////////////////////////////////FIXEDUPDATE
  /// IMPL////////////////////////////////////////////////////////
  // Holds actions received from another Thread. Will be coped to actionCopiedQueueFixedUpdateFunc
  // then executed from there
